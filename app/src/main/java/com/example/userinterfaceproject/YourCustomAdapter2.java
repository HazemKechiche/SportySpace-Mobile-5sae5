...
public class YourCustomAdapter2 extends RecyclerView.Adapter<YourCustomAdapter2.ViewHolder> {
    ...
    // Single constructor
    public YourCustomAdapter2(Context context, List<Terrain> TerrainList, TerrainDatabase db) {
